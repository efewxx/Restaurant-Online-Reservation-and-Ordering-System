        ...
        <div class="admin-form">
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <select name="p_category" required>
                    <option value="1" <?php if($product['category_id'] == 1) echo 'selected'; ?>>Main Dishes</option>
                    <option value="2" <?php if($product['category_id'] == 2) echo 'selected'; ?>>Drinks</option>
                    <option value="3" <?php if($product['category_id'] == 3) echo 'selected'; ?>>Desserts</option>
                </select>
